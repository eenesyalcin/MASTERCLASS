                ...
                <div class="row justify-content-end mb-5">
                    <div class="col-lg-4 d-none d-lg-block">
                        <div class="bg-lightgray text-center p-relative me-2">
                            <a href="employee-new-student.php" class="btn btn-primary p-absolute rounded-4" role="button">
                                ...
                                <table class="table shadow-lg table-hover table-striped table-responsive-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $employee_student_sql = "SELECT * FROM students";
                                            $employee_student_result = mysqli_query($connect, $employee_student_sql);
                                            if (!$employee_student_result) {
                                                die('An error occurred in the query: ' . mysqli_error($connect));
                                            }
                                            while($row = mysqli_fetch_assoc($employee_student_result)){
                                                ?>
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-end">
                                                        ...
                                                        <a href="employee-update-student.php?id=<?php echo $row['id'] ?>" type="submit" class="btn btn-warning btn-sm">
                                                            <i class="fa-solid fa-pen-to-square"></i>
                                                            <span>UPDATE</span>
                                                        </a>
                                                        <!-- Student Delete Button -->
                                                        <a href="employee-delete-student.php?id=<?php echo $row['id'] ?>" type="submit" class="btn btn-danger ms-2 btn-sm">
