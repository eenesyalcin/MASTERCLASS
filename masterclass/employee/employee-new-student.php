...
<?php
    ...
    if(isset($_POST["student_save"]))
    {
        ...
        $add = "INSERT INTO students(full_name, course_no, student_email, student_password, lessons) VALUES('$student_fullName','$student_courseNO','$student_save_email', '$student_save_password', '$student_save_lessons')";
        $addRun = mysqli_query($connect, $add);


        // Checking the correct sending of data to the database
        if($addRun){
            header("Location: employee-students.php? başarılı ");
        }
        else
        {
                ...
                <div class="row mb-5 justify-content-center">
                    <div class="col-lg-8 d-none d-lg-block shadow-s">
                        <div>
                            ...
                            <form action="employee-new-student.php" method="POST" class="p-5">
                                <!-- Full Name -->
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Full name" name="student_fullName">
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Course NO" name="student_courseNO">
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Example: MAÖ - PFY" name="student_save_lessons">
