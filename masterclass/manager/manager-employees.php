                ...
                <div class="row mb-5">
                    <div class="col-lg-12 d-none d-lg-block">
                        <div class="bg-lightgray text-center">
                            <i class="fs-1 fa-solid fa-user-group mb-3"></i>
                            <h2>EMPLOYEES</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-end mb-5">
                    <div class="col-lg-4 d-none d-lg-block">
                        <div class="bg-lightgray text-center p-relative me-2">
                            <a href="manager-new-employee.php" class="btn btn-primary p-absolute rounded-4" role="button">
                                ...
                                <table class="table shadow-lg table-hover table-striped table-responsive-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $manager_employee_sql = "SELECT * FROM employees";
                                            $manager_employee_result = mysqli_query($connect, $manager_employee_sql);
                                            if (!$manager_employee_result) {
                                                die('An error occurred in the query: ' . mysqli_error($connect));
                                            }
                                            while($row = mysqli_fetch_assoc($manager_employee_result)){
                                                ?>
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-end">
                                                        ...
                                                        <a href="manager-update-employee.php?id=<?php echo $row['id'] ?>" type="submit" class="btn btn-warning btn-sm">
                                                            <i class="fa-solid fa-pen-to-square"></i>
                                                            <span>UPDATE</span>
                                                        </a>
                                                        <!-- Employee Delete Button -->
                                                        <a href="manager-delete-employee.php?id=<?php echo $row['id'] ?>" type="submit" class="btn btn-danger ms-2 btn-sm">
